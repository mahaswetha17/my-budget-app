...
async function generateMonthlyReport(data) {
  try {
    ...
    const prompt = `You are a warm financial advisor helping someone understand their finances.
...
Write a friendly 3-paragraph report: greet them warmly, summarize the month in simple words, suggest 2-3 practical saving tips. Under 200 words. Be warm like a helpful family member.`;
    const result = await model.generateContent(prompt);
